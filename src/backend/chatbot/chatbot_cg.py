...
intents = json.loads(open('chatbot/intentsCG.json', errors="ignore").read())

words = pickle.load(open('chatbot/wordsCG.pkl', 'rb'))
classes = pickle.load(open('chatbot/classesCG.pkl', 'rb'))
model = load_model('chatbot/chatbot_CG_model.h5')
        ...
        if i['topic'] == topic:
            ...
            if response == "athlete":
                ...
                if course is not None:
                    ...
                    response = "∆ Please provide a athlete"
